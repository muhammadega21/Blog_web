    ...
    @if ($posts->count())
        <div class="card mb-3">
            ...
            <div class="card-body text-center">
                <h3 class="card-title"><a class="text-dark" href="/posts/{{ $posts[0]->slug }}">{{ $posts[0]->title }}</a>
                </h3>
                <small>
                    <p>By. <a href="/posts?author={{ $posts[0]->author->username }}">{{ $posts[0]->author->name }}</a>
            ...
            <div class="row">
                @foreach ($posts->skip(1) as $post)
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <div class="position-absolute text-white px-3 py-2" style="background-color: rgba(0, 0, 0, .7)">
                                <a class="text-white"
